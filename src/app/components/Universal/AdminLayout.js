...
const AdminLayout = ({ children, name, lastname, role }) => {
    ...
    const Menus = [
        ...
        },
        {
            ...
            src: "User",
            gap: false,
            DashoardLink: "../dashboard/admin/gradesAndClasses",
        },
        {
            title: "Analysis",
            src: "Calendar",
            DashoardLink: "../dashboard/admin/analysis",
        },
        {
            title: "Communicate",
            src: "/Search",
        ...
        >
            <div
                className={` ${open ? "w-72" : "w-20 "
                    } visuals min-h-screen p-5  pt-8 relative duration-300 border-none dark:bg-transparent shadow-slate-900 shadow-lg hidden md:block `}
            >
                <img
