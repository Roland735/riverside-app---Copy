...
const AssignmentCard = ({ averageMark, submissionRate, change }) => {
    return (
        <div className="bg-slate-300 dark:bg-slate-700 rounded-lg shadow-md p-4 mb-4">
            <h2 className="text-xl font-bold mb-4 dark:text-slate-50 text-cyan-950">Assignment Performance</h2>
            <div className="flex items-center justify-between mb-2 dark:text-slate-50 text-cyan-950">
                ...
                <div>
                    ...
                    <p className="text-sm dark:text-slate-50 text-cyan-950">Percentage of submissions</p>
                </div>
            </div>
