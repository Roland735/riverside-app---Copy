...
const StudentCard = ({
    ...
    // Reset comment  when a new student is selected
    useEffect(() => {
...
const TeacherComments = ({ year, period }) => {
    ...
    const handleSaveComment = async (
        ...
        try {
            ...
            // Update the classes state with the new comment 
            ...
            <div className="mb-4">
                {classes.map((classData, classIndex) => (
                    <div key={classIndex} className="mb-2">
                        {/* Accordion Header */}
                        <div
                            className={`p-2 cursor-pointer bg-gray-200 ${classIndex === activeClassIndex
                        ...
                        {classIndex === activeClassIndex && (
                            <div className="mt-2 ml-4">
                                {classData.students.map((student, studentIndex) => (
                                    <button
                                        key={studentIndex}
                                        className={`p-2 mr-2 mb-2 ${studentIndex === activeStudentIndex
