...
const Form = () => {
  ...
  const handleLogin = async (e) => {
    ...
    const res = await signIn("credentials", {
      email,
      password,
      regNumber, // Send the registration number
      redirect: false,
    });
    ...
    if (res.error) {
      ...
      router.replace("/dashboard"); // Use replace to reload the page
    }
  };
            ...
            <form className="space-y-4 md:space-y-6" onSubmit={handleLogin}>
              <div>
                ...
                <input
                  ...
                  required
                  onChange={(e) => setRegNumber(e.target.value)} // Update state
                />
              </div>
              <div>
                <label
